...
export const BILAN_CATALOG: BilanGroup[] = [
  ...
  {
    key: "hormonal",
    title: "Bilan hormonal (hypophyso-surrénalien)",
    fields: [
      { key: "bl_hor_cortisol", label: "Cortisol (8h)",      type: "number", unit: "µg/dL", placeholder: "15" },
      { key: "bl_hor_acth",     label: "ACTH",               type: "number", unit: "pg/mL", placeholder: "30" },
      { key: "bl_hor_prolactine", label: "Prolactine",       type: "number", unit: "ng/mL", placeholder: "15" },
      { key: "bl_hor_gh",       label: "GH (hormone de croissance)", type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_hor_igf1",     label: "IGF-1",              type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_hor_aldo",     label: "Aldostérone / Rénine", type: "text", placeholder: "Rapport aldostérone/rénine" },
      { key: "bl_hor_autres",   label: "Autres dosages",     type: "textarea", rows: 2, placeholder: "Test de freinage / stimulation…" },
    ],
  },
  {
    key: "gonadique",
    title: "Bilan hormonal gonadique & fertilité",
    fields: [
      { key: "bl_gon_fsh",    label: "FSH",              type: "number", unit: "UI/L",  placeholder: "" },
      { key: "bl_gon_lh",     label: "LH",               type: "number", unit: "UI/L",  placeholder: "" },
      { key: "bl_gon_e2",     label: "Œstradiol (E2)",   type: "number", unit: "pg/mL", placeholder: "" },
      { key: "bl_gon_prog",   label: "Progestérone",     type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_gon_testo",  label: "Testostérone",     type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_gon_prl",    label: "Prolactine",       type: "number", unit: "ng/mL", placeholder: "15" },
      { key: "bl_gon_amh",    label: "AMH",              type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_gon_bhcg",   label: "β-hCG",            type: "number", unit: "UI/L",  placeholder: "" },
    ],
  },
  {
    key: "serologique",
...
export const SPECIALTY_BILANS: Record<string, string[]> = {
  ...
  endocrinologie:      ["biologique", "radiologique", "metabolique", "thyroidien", "lipidique", "capillaire_urinaire", "degeneratif_diabete", "phosphocalcique", "hormonal", "gonadique"],
  ...
  gynecologie:         ["biologique", "radiologique", "hemogramme", "martial", "gonadique", "grossesse", "tumoraux"],
  gynecologie_med:     ["biologique", "radiologique", "hemogramme", "martial", "gonadique", "grossesse"],
