...
export const BILAN_CATALOG: BilanGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "bl_card_tropo", label: "Troponine",       type: "number", unit: "ng/mL", placeholder: "0.01" },
      { key: "bl_card_bnp",   label: "BNP / NT-proBNP", type: "number", unit: "pg/mL", placeholder: "100" },
      { key: "bl_echo_coeur", label: "Échocardiographie", type: "text", placeholder: "FE 60 %, pas de valvulopathie" },
      { key: "bl_card_effort", label: "Épreuve d'effort", type: "text", placeholder: "Négative, bien conduite" },
    ],
  },
  {
    key: "hepatique",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "bl_hem_ddim", label: "D-dimères",   type: "number", unit: "ng/mL", placeholder: "500" },
    ],
  },
  {
    key: "martial",
  ...
  {
    key: "phosphocalcique",
    title: "Bilan phosphocalcique & osseux",
    fields: [
      { key: "bl_pca_ca",      label: "Calcémie",             type: "number", unit: "mg/L",   placeholder: "95" },
      { key: "bl_pca_ca_corr", label: "Calcium corrigé",      type: "number", unit: "mg/L",   placeholder: "95" },
      { key: "bl_pca_ph",      label: "Phosphorémie",         type: "number", unit: "mg/L",   placeholder: "35" },
      { key: "bl_pca_pth",     label: "PTH",                  type: "number", unit: "pg/mL",  placeholder: "40" },
      { key: "bl_pca_vitd",    label: "Vitamine D (25-OH)",   type: "number", unit: "ng/mL",  placeholder: "30" },
      { key: "bl_pca_pal",     label: "Phosphatases alcalines", type: "number", unit: "UI/L", placeholder: "80" },
      { key: "bl_pca_calciurie", label: "Calciurie 24h",      type: "number", unit: "mg/24h", placeholder: "200" },
      { key: "bl_pca_dmo",     label: "Ostéodensitométrie (T-score)", type: "text", placeholder: "Rachis −1,5 · hanche −1,0" },
    ],
  },
  {
    key: "corticotrope",
    title: "Bilan corticotrope",
    fields: [
      { key: "bl_cort_cortisol8h", label: "Cortisol de 8h",                        type: "number", unit: "µg/dL",  placeholder: "15" },
      { key: "bl_cort_acth8h",     label: "ACTH de 8h",                            type: "number", unit: "pg/mL",  placeholder: "30" },
      { key: "bl_cort_clu24h",     label: "Cortisol libre urinaire de 24h",        type: "number", unit: "µg/24h", placeholder: "" },
      { key: "bl_cort_creat24h",   label: "Créatininurie de 24h",                  type: "number", unit: "g/24h",  placeholder: "1.2" },
      { key: "bl_cort_freinage",   label: "Freinage minute (1 mg Dexaméthasone)",  type: "text",   placeholder: "Cortisol post-freinage · freiné / non freiné" },
    ],
  },
  {
    key: "gonadotrope",
    title: "Bilan hormonal gonadotrope",
    fields: [
      { key: "bl_gonm_fsh",       label: "FSH",                  type: "number", unit: "UI/L",  placeholder: "" },
      { key: "bl_gonm_lh",        label: "LH",                   type: "number", unit: "UI/L",  placeholder: "" },
      { key: "bl_gonm_testo",     label: "Testostérone",         type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_gonm_e2",        label: "Estradiol (E2)",       type: "number", unit: "pg/mL", placeholder: "" },
      { key: "bl_gonm_bhcg",      label: "β-hCG",                type: "number", unit: "UI/L",  placeholder: "" },
      { key: "bl_gonm_prl",       label: "Prolactine",           type: "number", unit: "ng/mL", placeholder: "15" },
      { key: "bl_gonm_amh",       label: "AMH",                  type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_gonm_sdhea",     label: "SDHEA",                type: "number", unit: "µg/dL", placeholder: "" },
      { key: "bl_gonm_inhibineb", label: "Inhibine B",           type: "number", unit: "pg/mL", placeholder: "" },
      { key: "bl_gonm_echo_pelv", label: "Échographie pelvienne", type: "text",  placeholder: "Compte rendu" },
    ],
  },
  {
    key: "somatotrope",
    title: "Bilan somatotrope",
    fields: [
      { key: "bl_som_igf1",       label: "IGF-1",                        type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_som_gh_stim",    label: "Test de stimulation de la GH", type: "text", placeholder: "Pic de GH · réponse" },
      { key: "bl_som_irm",        label: "IRM hypothalamo-hypophysaire", type: "text", placeholder: "Compte rendu" },
      { key: "bl_som_age_osseux", label: "Âge osseux",                   type: "text", placeholder: "Ex. 12 ans (Greulich & Pyle)" },
    ],
  },
  {
    key: "serologique",
    ...
    fields: [
      { key: "bl_ser_vih",    label: "Sérologie VIH",    type: "select", options: ["Non fait", "Négatif", "Positif"] },
      { key: "bl_ser_hbs",    label: "Ag HBs",           type: "select", options: ["Non fait", "Négatif", "Positif"] },
      { key: "bl_ser_antihbs", label: "Ac anti-HBs",     type: "text",   placeholder: "Titre / négatif" },
      { key: "bl_ser_vhc",    label: "Sérologie VHC",    type: "select", options: ["Non fait", "Négatif", "Positif"] },
      { key: "bl_ser_syphilis", label: "TPHA / VDRL (syphilis)", type: "text", placeholder: "Négatif" },
      { key: "bl_ser_autres", label: "Autres sérologies", type: "textarea", rows: 2, placeholder: "Toxoplasmose, rubéole, CMV, EBV…" },
    ],
  },
  {
    key: "tumoraux",
    ...
    fields: [
      { key: "bl_tum_psa",    label: "PSA (total)",      type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_tum_psa_l",  label: "PSA libre / ratio", type: "text",  placeholder: "" },
      { key: "bl_tum_ace",    label: "ACE",              type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_tum_afp",    label: "AFP (α-fœtoprotéine)", type: "number", unit: "ng/mL", placeholder: "" },
      { key: "bl_tum_ca199",  label: "CA 19-9",          type: "number", unit: "U/mL",  placeholder: "" },
      { key: "bl_tum_ca125",  label: "CA 125",           type: "number", unit: "U/mL",  placeholder: "" },
      { key: "bl_tum_ca153",  label: "CA 15-3",          type: "number", unit: "U/mL",  placeholder: "" },
    ],
  },
  {
    key: "auto_immun",
    title: "Bilan immunologique & auto-immun",
    fields: [
      { key: "bl_imm_fr",     label: "Facteur rhumatoïde (FR)", type: "number", unit: "UI/mL", placeholder: "" },
      { key: "bl_imm_ccp",    label: "Anticorps anti-CCP",  type: "number", unit: "U/mL", placeholder: "" },
      { key: "bl_imm_aan",    label: "AAN (FAN)",           type: "text",   placeholder: "Négatif / titre 1:160 moucheté" },
      { key: "bl_imm_dna",    label: "Anti-ADN natif",      type: "text",   placeholder: "Négatif" },
      { key: "bl_imm_ena",    label: "Anticorps anti-ENA",  type: "text",   placeholder: "Négatif" },
      { key: "bl_imm_anca",   label: "ANCA",                type: "text",   placeholder: "Négatif" },
      { key: "bl_imm_compl",  label: "Complément (C3 / C4)", type: "text",  placeholder: "C3 normal · C4 normal" },
    ],
  },
  {
    key: "pancreatique",
    title: "Bilan pancréatique",
    fields: [
      { key: "bl_pan_amylase", label: "Amylasémie",       type: "number", unit: "UI/L", placeholder: "60" },
      { key: "bl_pan_lipase",  label: "Lipasémie",        type: "number", unit: "UI/L", placeholder: "40" },
      { key: "bl_pan_gly",     label: "Glycémie",         type: "number", unit: "g/L",  placeholder: "1.0" },
      { key: "bl_pan_ca",      label: "Calcémie",         type: "number", unit: "mg/L", placeholder: "95" },
      { key: "bl_pan_crp",     label: "CRP",              type: "number", unit: "mg/L", placeholder: "5" },
    ],
  },
  {
    key: "allergologique",
    ...
    fields: [
      { key: "bl_all_ige_t",  label: "IgE totales",      type: "number", unit: "UI/mL", placeholder: "100" },
      { key: "bl_all_ige_s",  label: "IgE spécifiques",  type: "text",   placeholder: "Acariens, pollens, arachide…" },
      { key: "bl_all_eosino", label: "Éosinophiles",     type: "number", unit: "G/L",  placeholder: "0.3" },
      { key: "bl_all_prick",  label: "Tests cutanés (prick tests)", type: "text", placeholder: "Positif aux acariens…" },
      { key: "bl_all_autres", label: "Autres",           type: "text",   placeholder: "" },
    ],
  },
  {
    key: "grossesse",
    title: "Bilan prénatal / grossesse",
    fields: [
      { key: "bl_gro_bhcg",   label: "β-hCG",            type: "number", unit: "UI/L", placeholder: "" },
      { key: "bl_gro_groupe", label: "Groupe / Rh + RAI", type: "text",  placeholder: "O Rh+ · RAI négatif" },
      { key: "bl_gro_nfs",    label: "NFS",              type: "text",   placeholder: "Hb 12 g/dL" },
      { key: "bl_gro_ferritine", label: "Ferritine",     type: "number", unit: "µg/L", placeholder: "40" },
      { key: "bl_gro_gly",    label: "Glycémie à jeun / HGPO", type: "text", placeholder: "0.85 g/L · HGPO normal" },
      { key: "bl_gro_toxo",   label: "Sérologie toxoplasmose", type: "select", options: ["Non fait", "Immunisée", "Non immunisée", "Séroconversion"] },
      { key: "bl_gro_rubeole", label: "Sérologie rubéole", type: "select", options: ["Non fait", "Immunisée", "Non immunisée"] },
      { key: "bl_gro_autres", label: "Autres sérologies (VIH, hép. B, syphilis…)", type: "textarea", rows: 2, placeholder: "" },
      { key: "bl_gro_ecbu",   label: "ECBU",             type: "text",   placeholder: "Stérile" },
    ],
  },
  {
    key: "respiratoire",
    title: "Fonction respiratoire (EFR)",
    fields: [
      { key: "bl_efr_vems",   label: "VEMS",             type: "number", unit: "L",  placeholder: "2.8" },
      { key: "bl_efr_cvf",    label: "CVF",              type: "number", unit: "L",  placeholder: "3.5" },
      { key: "bl_efr_ratio",  label: "VEMS/CVF (Tiffeneau)", type: "number", unit: "%", placeholder: "80" },
      { key: "bl_efr_trouble", label: "Type de trouble", type: "select", options: ["Normal", "Obstructif", "Restrictif", "Mixte"] },
      { key: "bl_efr_dlco",   label: "DLCO",             type: "number", unit: "%",  placeholder: "90" },
      { key: "bl_efr_spo2",   label: "SpO₂ repos",       type: "number", unit: "%",  placeholder: "97" },
    ],
  },
  {
    key: "specialise",
    ...
    fields: [
      { key: "bl_spec_titre",    label: "Intitulé du bilan", type: "text", placeholder: "Autre bilan, dosage spécifique…" },
...
export const SPECIALTY_BILANS: Record<string, string[]> = {
  medecin_generaliste: ["biologique", "radiologique", "hemogramme", "inflammatoire", "lipidique", "serologique"],
  medecine_interne:    ["biologique", "radiologique", "hemogramme", "inflammatoire", "hepatique", "renal", "auto_immun", "serologique"],
  medecine_urgence:    ["biologique", "radiologique", "hemogramme", "gazometrie", "inflammatoire", "hemostase", "cardiaque"],
  geriatrie:           ["biologique", "radiologique", "hemogramme", "renal", "vitaminique", "phosphocalcique"],
  cardiologie:         ["biologique", "radiologique", "cardiaque", "lipidique", "hemostase"],
  endocrinologie:      ["biologique", "radiologique", "metabolique", "thyroidien", "lipidique", "capillaire_urinaire", "degeneratif_diabete", "phosphocalcique", "corticotrope", "gonadotrope", "somatotrope"],
  nephrologie:         ["biologique", "radiologique", "renal", "hemogramme", "urinaire", "phosphocalcique", "auto_immun"],
  gastroenterologie:   ["biologique", "radiologique", "hepatique", "inflammatoire", "pancreatique", "tumoraux"],
  pneumologie:         ["biologique", "radiologique", "gazometrie", "inflammatoire", "respiratoire", "allergologique"],
  infectiologie:       ["biologique", "radiologique", "inflammatoire", "hemogramme", "urinaire", "serologique"],
  ...
  psychiatrie:         ["biologique", "thyroidien", "vitaminique"],
