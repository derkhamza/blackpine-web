...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .title { text-align: center; font-size: 13pt; font-weight: bold; color: var(--doc-accent,#0A4E7E);
    ...
    .indication strong { color: var(--doc-accent,#0A4E7E); }
    ...
    .exr-item::before { content: "▪"; position: absolute; left: 2px; color: var(--doc-accent,#0A4E7E); font-size: 8pt; top: 4px; }
