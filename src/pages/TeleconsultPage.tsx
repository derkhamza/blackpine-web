                  ...
                  <div className="tele-row-actions">
                    {s.link && (
                      <button className="tele-action-btn" onClick={() => copyLink(s.link!, s.id)}
                        aria-label={t("teleconsult.copyLink", { defaultValue: "Copier le lien" })}
                        title={t("teleconsult.copyLink", { defaultValue: "Copier le lien" })}>
                        {copied === s.id
                    ...
                    {s.link && (
                      <a href={s.link} target="_blank" rel="noopener noreferrer"
                        ...
                        aria-label={t("teleconsult.openLink", { defaultValue: "Ouvrir le lien" })}
                        title={t("teleconsult.openLink", { defaultValue: "Ouvrir le lien" })}>
                        <svg width="13" height="13" viewBox="0 0 14 14" fill="none">
                    ...
                    {s.patientPhone && shareTemplate && (
                      <a href={buildWaUrl(s, shareTemplate.body)} target="_blank" rel="noopener noreferrer"
                        ...
                        aria-label={t("teleconsult.shareWa", { defaultValue: "Partager par WhatsApp" })}
                        title={t("teleconsult.shareWa", { defaultValue: "Partager par WhatsApp" })}>
                    ...
                    {s.status === "scheduled" && (
                      <button className="tele-action-btn primary"
                        aria-label={t("teleconsult.start", { defaultValue: "Démarrer la séance" })}
                        title={t("teleconsult.start", { defaultValue: "Démarrer la séance" })}
                    ...
                    {s.status === "in_progress" && (
                      <button className="tele-action-btn primary"
                        aria-label={t("teleconsult.complete", { defaultValue: "Terminer la séance" })}
                        title={t("teleconsult.complete", { defaultValue: "Terminer la séance" })}
